...
void ballTrackbarsCreator(std::string window_name, void *data)
{
    createTrackbar("H Ball Min", window_name, &ballHMin, 179, setBallHMin, data);
    createTrackbar("H Ball Max", window_name, &ballHMax, 179, setBallHMax, data);
