...
void Extraction::execute(objectsContours contours)
{
...
void Extraction::extractBall(std::vector<cv::Point> ballContour)
{
...
void Extraction::extractEnemy(std::vector<std::vector<cv::Point>> enemyContours)
{
